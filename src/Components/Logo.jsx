  ...
  return (
    <>
      <header className=" flex items-center justify-center">
        <h1 className=" tracking-wider font-semibold mt-14 text-4xl text-yellow-500  font-Proxima">
          ToDo{" "}
        </h1>
      </header>
      <div className=" flex items-center justify-center">
      <div className="mt-8 ml-4 timedate text-left">
        <p className="text-3xl tracking-wider font-sans text-white">
          {formattedTime}
        </p>
        <p className="text-xs  text-teal-100">{formattedDate}</p>
      </div></div>
    </>
  );
};
